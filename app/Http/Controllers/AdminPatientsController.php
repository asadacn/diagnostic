<?php namespace App\Http\Controllers;
	...
	class AdminPatientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Contact','name'=>'contact','type'=>'text','validation'=>'required|min:1|max:15','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Address','name'=>'address','type'=>'textarea','validation'=>'nullable|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Age','name'=>'age','type'=>'text','validation'=>'nullable|min:1|max:3','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
